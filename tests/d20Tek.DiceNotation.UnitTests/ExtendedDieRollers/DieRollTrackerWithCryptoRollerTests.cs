...
{
    /// <summary>
    /// Summary description for DieRollTrackerWithCryptoRollerTests
    /// </summary>
    [TestClass]
    public class DieRollTrackerWithCryptoRollerTests
    {
        ...
        public DieRollTrackerWithCryptoRollerTests()
        {
        ...
        [TestMethod]
        public void DieRollTrackerWithSecureRoller_SingleDieSidesTest()
        {
            // setup test
            this.roller.Roll(12);
            this.roller.Roll(12);
        ...
        [TestMethod]
        public void DieRollTrackerWithSecureRoller_MultipleDieSidesTest()
        {
            // setup test
            this.roller.Roll(12);
            this.roller.Roll(12);
