...
public class ParserTests
{
    ...
    [
        ...
        ["1d%+5", new BinaryExpression(new DiceExpr(new NumberExpression(1, new(0)), true, null, _emptyModifiers, new(1)), BinaryOperator.Add, new NumberExpression(5, new(4)), new(3))],
