...
public class ParserTests
{
    ...
    [
        ...
        ["+5 + 4d6", new BinaryExpression(new UnaryExpression(UnaryOperator.Positive, new NumberExpression(5, new(1)), new(0)), BinaryOperator.Add, new DiceExpr(new NumberExpression(4, new(5)), false, new NumberExpression(6, new(7)), _emptyModifiers, new(6)), new(3))],
        ...
        ["d%+5", new BinaryExpression(new DiceExpr(null, true, new NumberExpression(100, new(1)), _emptyModifiers, new(0)), BinaryOperator.Add, new NumberExpression(5, new(3)), new(2))],
        ["1d%+5", new BinaryExpression(new DiceExpr(new NumberExpression(1, new(0)), true, new NumberExpression(100, new(2)), _emptyModifiers, new(1)), BinaryOperator.Add, new NumberExpression(5, new(4)), new(3))],
